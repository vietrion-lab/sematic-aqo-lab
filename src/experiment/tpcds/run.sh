#!/usr/bin/env bash
# =============================================================================
# TPC-DS Experiment Runner  (standalone, with checkpoint/resume)
#
# Runs 2 modes × N iterations: no_aqo (baseline) & with_aqo (semantic AQO)
# Results written to experiment/tpcds/results/
# Completed phases are skipped on re-run.  Use --force to re-run everything.
#
# Usage:  bash experiment/tpcds/run.sh [iterations] [--force]
# =============================================================================
